...
public class PaymentServiceImpl implements PaymentService {
	...
	public void registOrder(OrderSummary orderSummary, Receiver receiver) {
		...
		//주문 요약이 등록된 이후, orderSummary VO에는 mybatis의 selectKey에 의해 order_sumamry_id가 채워져 있다
		//따라서 취즉한 주문 번호를 받는 사람, 상세에 넣어줘야 한다
		
		//받는 사람 정보 등록
		receiver.setOrder_summary_id(orderSummary.getOrder_summary_id());  //주문 번호 전달
