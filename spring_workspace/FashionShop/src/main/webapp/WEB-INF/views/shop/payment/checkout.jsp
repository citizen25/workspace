						...
						<form id="checkout-form">
							...
							<div class="row">
								...
								<div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" id="member_phone"  value="010-3333-3333" required>
								</div>
								...
								<div class="col-md-6 mb-3">
									<label for="first_name">받으실 분 이름<span>*</span></label>
				...
				<div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
					<div class="order-details-confirmation">
						...
						<ul class="order-details-form mb-4">
							...
							<li><span>최종 결제하실 금액</span> <span>$59.90</span></li>
						</ul>
