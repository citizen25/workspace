...
<%
	...
	//System.out.println("가져온 상품의 수는 " + productList.size());
%>
<!DOCTYPE html>
<html lang="en">
							...
							<div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig" data-wow-delay="0.2s">
								...
								<div class="product-img">
									...
									<div class="product-quicview">
										<a href="javascript:alert('클릭')" data-toggle="modal" data-target="#quickview">
											<i class="ti-plus" 
